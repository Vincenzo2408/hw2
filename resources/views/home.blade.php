<html> 
    <head>
        ...
        <link rel="stylesheet" href='{{ url("css/ferrovia_finale.css")}}'/> 
        <script src='{{url("js/caricamento_api.js")}}' defer></script>
        <script type="text/javascript">
            const REGISTER_ROUTE = "{{route('home')}}";
        </script>
    </head> 
    <body> 
        <header>
            <nav> 
                <div id="collegamenti">
                    <a class='bottone' href='{{url("http://www.grandistazioni.it/content/grandiStazioni/it/le-nostre-stazioni/milano-centrale.html")}}'>Sito originale</a>
                    <a class='bottone' href='{{url("https://it.wikipedia.org/wiki/Stazione_di_Milano_Centrale")}}'>Chi siamo?</a>
                    @if(session('user_id') != null)
                            <a class='bottone' href="{{route('area_personale')}}">Area personale</a>
                            <a class='bottone' href="{{route('logout')}}">Effettua Logout</a>
                            
                            @else
                               
                            <a class='bottone' href="{{route('login')}}">Accedi</a>
                            <a class='bottone' href="{{route('register')}}">Registrazione</a>
                        @endif
                </div>
            </nav>
            <div id="frase">
        ...
        <section id="covid"> 
            ...
            <h3> Per maggiori informazioni:<a class="riduzione" href="{{url('https://www.governo.it/it/coronavirus')}}">Clicca Qui</a></h3>
